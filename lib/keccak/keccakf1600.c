...
typedef uint64_t (Line)[5];

void ethash_keccakf1600_modified(uint64_t state[25]) __attribute__((target("bmi,bmi2")));
void ethash_keccakf1600_modified(uint64_t state[25])
{
    ...
    for (int round = 0; round < 24; round += 2)
    {
        ...
        C[2] = E[0][2] ^ E[1][2] ^ E[2][2] ^ E[3][2] ^ E[4][2];
        C[3] = E[0][3] ^ E[1][3] ^ E[2][3] ^ E[3][3] ^ E[4][3];
        C[4] = E[0][4] ^ E[1][4] ^ E[2][4] ^ E[3][4] ^ E[4][4];
        ...
        C[0] = rol(E[0][3] ^ D[3], 28);
        C[1] = rol(E[1][4] ^ D[4], 20);
        C[2] = rol(E[2][0] ^ D[0], 3);
        C[3] = rol(E[3][1] ^ D[1], 45);
        C[4] = rol(E[4][2] ^ D[2], 61);
        A[1][0] = C[0] ^ (~C[1] & C[2]);
        A[1][1] = C[1] ^ (~C[2] & C[3]);
        A[1][2] = C[2] ^ (~C[3] & C[4]);
        A[1][3] = C[3] ^ (~C[4] & C[0]);
        ...
        C[0] = rol(E[0][1] ^ D[1], 1);
        C[1] = rol(E[1][2] ^ D[2], 6);
        C[2] = rol(E[2][3] ^ D[3], 25);
        C[3] = rol(E[3][4] ^ D[4], 8);
        C[4] = rol(E[4][0] ^ D[0], 18);
        A[2][0] = C[0] ^ (~C[1] & C[2]);
        A[2][1] = C[1] ^ (~C[2] & C[3]);
        A[2][2] = C[2] ^ (~C[3] & C[4]);
        A[2][3] = C[3] ^ (~C[4] & C[0]);
        ...
        C[0] = rol(E[0][4] ^ D[4], 27);
        C[1] = rol(E[1][0] ^ D[0], 36);
        C[2] = rol(E[2][1] ^ D[1], 10);
        C[3] = rol(E[3][2] ^ D[2], 15);
        C[4] = rol(E[4][3] ^ D[3], 56);
        A[3][0] = C[0] ^ (~C[1] & C[2]);
        A[3][1] = C[1] ^ (~C[2] & C[3]);
        A[3][2] = C[2] ^ (~C[3] & C[4]);
        A[3][3] = C[3] ^ (~C[4] & C[0]);
        ...
        C[0] = rol(E[0][2] ^ D[2], 62);
        C[1] = rol(E[1][3] ^ D[3], 55);
        C[2] = rol(E[2][4] ^ D[4], 39);
        C[3] = rol(E[3][0] ^ D[0], 41);
        C[4] = rol(E[4][1] ^ D[1], 2);
        A[4][0] = C[0] ^ (~C[1] & C[2]);
        A[4][1] = C[1] ^ (~C[2] & C[3]);
        A[4][2] = C[2] ^ (~C[3] & C[4]);
